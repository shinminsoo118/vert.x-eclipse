 ...
 */
public class SharedDataTest extends AsyncTestBase {
  ...
  public void testPutNullKey() {
    vertices[0].sharedData().<String, String>getClusterWideMap("foo", ar -> {
      assertTrue(ar.succeeded());
  ...
  public void testPutInvalidKey() {
    vertices[0].sharedData().<SomeObject, String>getClusterWideMap("foo", ar -> {
      assertTrue(ar.succeeded());
  ...
  public void testPutInvalidValue() {
    vertices[0].sharedData().<String, SomeObject>getClusterWideMap("foo", ar -> {
      assertTrue(ar.succeeded());
  ...
  public void testMultipleMaps() {
    vertices[0].sharedData().<String, String>getClusterWideMap("foo", ar -> {
      ...
      map.put("foo", "bar", ar2 -> {
        ...
        vertices[1].sharedData().<String, String>getClusterWideMap("bar", ar3 -> {
  ...
  public void testClear() {
    vertices[0].sharedData().<String, String>getClusterWideMap("foo", ar -> {
      ...
      map.put("foo", "bar", ar2 -> {
        assertTrue(ar2.succeeded());
        vertices[1].sharedData().<String, String>getClusterWideMap("foo", ar3 -> {
          AsyncMap<String, String> map2 = ar3.result();
          map2.clear(ar4 -> {
  ...
  private <K, V> void testMapPutGet(K k, V v) {
    vertices[0].sharedData().<K, V>getClusterWideMap("foo", ar -> {
      assertTrue(ar.succeeded());
      AsyncMap<K, V> map = ar.result();
      map.put(k, v, ar2 -> {
        assertTrue(ar2.succeeded());
        vertices[1].sharedData().<K, V>getClusterWideMap("foo", ar3 -> {
