...
public class DeploymentManager {
  ...
  private DeploymentFactories defaultFactories;

  public DeploymentManager(VertxInternal vertx) {
    this.vertx = vertx;
    this.defaultFactories = new DeploymentFactories(vertx, Thread.currentThread().getContextClassLoader());
  }
  ...
  private void doDeployVerticle(String identifier,
    ...
    if (cl instanceof IsolatingClassLoader) {
      verticleFactories = new DeploymentFactories(vertx, cl).resolveFactories(identifier);
    } else {
      verticleFactories = defaultFactories.resolveFactories(identifier);
    }
  ...
  public void registerVerticleFactory(VerticleFactory factory) {
    defaultFactories.registerVerticleFactory(factory);
  }

  public void unregisterVerticleFactory(VerticleFactory factory) {
    defaultFactories.unregisterVerticleFactory(factory);
  }

  public Set<VerticleFactory> verticleFactories() {
    return defaultFactories.verticleFactories();
  }
